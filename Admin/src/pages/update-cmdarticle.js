...
import { updateCmdArticle } from '../api/cmdarticle'; // import the createUser function from your API file
...
export default function Update() {
    ...
    const handleSubmit = () => {
        ...
        if (window.confirm("Voullez vous vraiment continuer cet Modification ?")) {
            updateCmdArticle(updatedCmdArticle, id)
                .then((res) => {
                    console.log(res)
    ...
    return (
        <form>
            <h2>Confirmer ou Annuler une Commande d'achat d'article</h2>
